...
| ------------- | ------------------|---------------------------------------------------------------|------------|
| Unit 1        | Data Structures   |Python Syntax, loops, comprehension, advanced python constrains|Lessons 1-2 |
| Unit 2        | Array with Numpy  |Numpy array                                                    |Lessons 3-4 |
| Unit 3        | Pandas            |Pandas library                                                 |Lessons 5-6 |
| Unit 4        | Matplot lib       |Matplot lib, seaborn and visualization                         |Lessons 7-8 |
| Unit 5        | Weather Data      |loading data, data manipulation, and other python applications |Lessons 9-10|
...
| Python loops, sequences and dictionaries                 |Unit 2  |Session 4  |
| Numpy arrays                                             |Unit 3  |Session 5  |
| Doing math with Numpy                                    |Unit 3  |Session 6  |
| Pandas dataframe and series                              |Unit 4  |Session 7  |
| Data plots                                               |Unit 4  |Session 8  |
| Weather Data loading data, filling the missing values    |Unit 4  |Session 7  |
| Weather data anomality detection                         |Unit 4  |Session 8  |
...
# Assignments chedule
At the end of each Unit, you'll work on the assignments. These activities will test your understanding of that unit’s most important concepts with in-class practice and instructor support.

Assignment 1: Due @ End of Unit 1
Assignment 2: Due @ End of Unit 2
Assignment 3: Due @ End of Unit 3
Assignment 4 (Final):
...
Python codebook and report: Due @ End of Unit 3
Technical debrief: Due @ End of Unit 4
...
Slack me at Naumaan N or post in our #dat-jan20 channel to reserve a time-slot!
...
UCI Spring 2022 Python for Data Analysis - Exit Ticket
